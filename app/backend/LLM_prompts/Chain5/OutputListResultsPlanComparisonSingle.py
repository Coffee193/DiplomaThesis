def getPrompt(user_question, recommended_doc_name):
...
IMPORTANT: Based on the analysis of all uploaded Output files, the plan with the shortest overall duration (makespan) is from the file: "{recommended_doc_name}".
After placing (DATA), recommend this plan to the user as it has the shortest makespan. Mention the document name "{recommended_doc_name}" in your recommendation.

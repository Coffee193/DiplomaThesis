...
export const TermsPoliciesCheckbox = forwardRef(({ valuesRef, warningIndex, warningvalueIndex, tabIndex, onpressEnter, onpressEnterValue, onpressTab, onpressTabValue}, termspoliciesRef) => {
    ...
    return(
        <div className='tpc_termsholder'>
            ...
            <div>
                By Signing Up you agree to our <Link className='tpc_termslink' to='/termspolicies' tabIndex={tabIndex}>Terms of Use</Link> and our <Link className='tpc_termslink' to='/termspolicies' tabIndex={tabIndex}>Privacy Policy</Link>
            </div>
        </div>
    )
})
...
user_question = "Hello how is the weather"
...
2. The JSON object must have exactly two fields:
    ...
    - "think": a short explanation of how the matches were identified based strictly on visible patterns.

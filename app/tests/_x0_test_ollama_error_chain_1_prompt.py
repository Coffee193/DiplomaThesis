def getPrompt(user_question):
    system_prompt = """You previously received a user question, but your response resulted in an invalid (non-JSON) output and caused an error. Your task is to respond to the user in a polite and helpful manner.

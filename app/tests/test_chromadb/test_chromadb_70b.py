...
collection = client.get_or_create_collection(
    name = 'alice_in_wonderland_word_based_1Ktoken',
    embedding_function = OllamaEmbeddingFunction(model_name = 'llama3.1'),
    metadata = { "created": str(datetime.datetime.now()), "description": "created for testing chromadb", "chunksize": "2500token, each token is an english word", "overlap": "500 tokens" },
    )
'''

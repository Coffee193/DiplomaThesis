...
collection = client.get_or_create_collection(
    name = 'alice_in_wonderland_word_based_embmodel_e5',
    embedding_function = OllamaEmbeddingFunction(model_name = 'jeffh/intfloat-multilingual-e5-large-instruct:f32'),
